...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 font-sans dark:bg-zinc-950">
      {/* Hero Section */}
      <header className="relative w-full overflow-hidden bg-white dark:bg-zinc-950 pt-16 pb-12 sm:pt-20 sm:pb-20">
        ...
        {/* High-Visibility Technical Blueprint Grid */}
        <div className="absolute inset-0 z-0 overflow-hidden">
          <motion.div
            ...
            className="absolute inset-0 z-0 bg-[linear-gradient(to_right,#80808033_1px,transparent_1px),linear-gradient(to_bottom,#80808033_1px,transparent_1px)] bg-[size:40px_40px] dark:bg-[linear-gradient(to_right,#ffffff1a_1px,transparent_1px),linear-gradient(to_bottom,#ffffff1a_1px,transparent_1px)]"
          />
          {/* The 'Scan Line' Glow Effect */}
          <motion.div
            animate={{
              top: ["-10%", "110%"]
            }}
            ...
            className="absolute left-0 right-0 h-20 bg-gradient-to-b from-transparent via-cyan-500/10 to-transparent z-1 pointer-events-none"
          />
        </div>
        <div className="absolute inset-0 z-0 bg-[radial-gradient(#80808020_1px,transparent_1px)] bg-[size:20px_20px] pointer-events-none opacity-40" />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg font-medium leading-relaxed text-zinc-600 dark:text-zinc-400 sm:text-2xl sm:mt-6">
          ...
          {/* The Social Proof block has been removed for a cleaner editorial look */}
          <div className="h-12" />
        </div>
      ...
      <main className="relative z-20 -mt-24 transition-colors duration-300">
        {/* Title Section (Restricted Width) */}
        <section className="mx-auto max-w-7xl px-6 pt-24 pb-12 text-center lg:px-8 bg-white dark:bg-zinc-950 rounded-t-[4rem] shadow-[0_-30px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_-30px_60px_-15px_rgba(0,0,0,0.5)]">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        {/* Infinite Marquee Container (Full-Width Bleed) */}
        <div className="relative w-full overflow-hidden py-12 transition-colors duration-300">
          {/* Edge Masks (Transparent in Light, Fading in Dark) */}
          <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-transparent dark:from-zinc-950 to-transparent z-10 pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-transparent dark:from-zinc-950 to-transparent z-10 pointer-events-none" />
            ...
            >
                ...
                {[...featuredPhotos, ...featuredPhotos].map((photo, idx) => (
                    <motion.div 
                        key={`${photo.id}-${idx}`} 
                        className="relative flex-shrink-0 w-[480px] aspect-video overflow-hidden rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] dark:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.7)] bg-white/70 dark:bg-zinc-900/90 backdrop-blur-3xl border border-zinc-200/50 dark:border-white/5 group transition-all"
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-zinc-900/95 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 pointer-events-none">
                            <p className="text-cyan-400 text-[10px] font-black uppercase tracking-[0.4em] mb-1 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">Master Series</p>
                            <h4 className="text-white font-black text-xl leading-tight translate-y-4 group-hover:translate-y-0 transition-transform duration-700 delay-75">{photo.categories?.[0] || "Curated Discovery"}</h4>
                        </div>
                    </motion.div>
                ))}
            </motion.div>
        ...
        {/* Bottom CTA Section (Back to Restricted Width) */}
        <section className="mx-auto max-w-7xl px-6 py-16 text-center lg:px-8">
          <div className="flex justify-center">
            <Link
              href="/gallery"
              className="group relative flex items-center gap-2 rounded-2xl bg-zinc-900 px-10 py-5 text-sm font-bold text-white transition-all hover:scale-[1.02] active:scale-95 dark:bg-zinc-100 dark:text-zinc-900 shadow-xl"
            >
